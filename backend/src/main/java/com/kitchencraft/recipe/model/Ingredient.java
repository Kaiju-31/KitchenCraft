...
public class Ingredient {
    ...
    // New fields for nutrition system (all nullable for backward compatibility)
    @Column
    ...
    // Helper method to check if this is a legacy ingredient (only name + category)
    public boolean isLegacyIngredient() {
        return brand == null && barcode == null && basicCategory == null;
    }

    // Helper method to get the appropriate category for display
    public String getDisplayCategory() {
        return basicCategory != null ? basicCategory : category;
    }
}
